	...
	switch(id)
	{
		case IDC_P2PLIST:
		{
			...
			if (IsDlgButtonChecked(hwnd, IDC_P2PLIST)==BST_CHECKED)
			{
				...
				AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/level-1"), _T("Default P2P List"), List::Block);
				EnableWindow(GetDlgItem(hwnd, IDC_OPENP2P), true);
			}
			else
			{
				TRACEI("[listsproc] [Lists_OnCommand]    P2P list now NOT selected");
				RemoveFromDefLists(_T("https://list.iblocklist.com/lists/bluetack/level-1"));
		...
		case IDC_SPYLIST:
		{
			...
			if (IsDlgButtonChecked(hwnd, IDC_SPYLIST)==BST_CHECKED)
			{
				...
				AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/spyware"), _T("Default Spy List"), List::Block);
				EnableWindow(GetDlgItem(hwnd, IDC_OPENSPY), true);
			}
			else
			{
				TRACEI("[listsproc] [Lists_OnCommand]    Spy list now NOT selected");
				RemoveFromDefLists(_T("https://list.iblocklist.com/lists/bluetack/spyware"));
		...
		case IDC_ADSLIST:
		{
			...
			if (IsDlgButtonChecked(hwnd, IDC_ADSLIST)==BST_CHECKED)
			{
				...
				AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n"), _T("Default Ads List"), List::Block);
				EnableWindow(GetDlgItem(hwnd, IDC_OPENADS), true);
			}
			else
			{
				TRACEI("[listsproc] [Lists_OnCommand]    Ads list now NOT selected");
				RemoveFromDefLists(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n"));
		...
		case IDC_EDULIST:
		{
			...
			if (IsDlgButtonChecked(hwnd, IDC_EDULIST)==BST_CHECKED)
			{
				...
				AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/edu"), _T("Default Edu List"), List::Block);
				EnableWindow(GetDlgItem(hwnd, IDC_OPENEDU), true);
			}
			else
			{
				TRACEI("[listsproc] [Lists_OnCommand]    Edu list now NOT selected");
				RemoveFromDefLists(_T("https://list.iblocklist.com/lists/bluetack/edu"));
		...
		case IDC_OPENP2P:
		{
			...
			vector<DynamicList>::size_type i = FindInDefLists(_T("https://list.iblocklist.com/lists/bluetack/level-1"));
			if (i != -1)
			{
		...
		case IDC_OPENSPY:
		{
			...
			vector<DynamicList>::size_type i = FindInDefLists(_T("https://list.iblocklist.com/lists/bluetack/spyware"));
			if (i != -1)
			{
		...
		case IDC_OPENADS:
		{
			...
			vector<DynamicList>::size_type i = FindInDefLists(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n"));
			if (i != -1)
			{
		...
		case IDC_OPENEDU:
		{
			...
			vector<DynamicList>::size_type i = FindInDefLists(_T("https://list.iblocklist.com/lists/bluetack/edu"));
			if (i != -1)
			{
		...
		case IDC_ADD:
		{
			...
			if(DialogBoxParam(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ADDLIST), hwnd, AddList_DlgProc, (LPARAM)&l)==IDOK)
			{
				...
				if (s.compare(_T("https://list.iblocklist.com/lists/bluetack/level-1")) == 0 ||
					s.compare(_T("https://list.iblocklist.com/lists/bluetack/spyware")) == 0 ||
					s.compare(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n")) == 0 ||
					s.compare(_T("https://list.iblocklist.com/lists/bluetack/edu")) == 0 )
				{
					// found dupe
					...
					else
					{
						...
						else if (s.compare(_T("https://list.iblocklist.com/lists/bluetack/spyware")) == 0)
						{
							AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/spyware"), _T("Default Spy List"), List::Block);
							EnableWindow(GetDlgItem(hwnd, IDC_OPENSPY), true);
							CheckDlgButton(hwnd, IDC_SPYLIST, BST_CHECKED);
						}
						else if (s.compare(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n")) == 0)
						{
							AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n"), _T("Default Ads List"), List::Block);
							EnableWindow(GetDlgItem(hwnd, IDC_OPENADS), true);
							CheckDlgButton(hwnd, IDC_ADSLIST, BST_CHECKED);
						}
						else if (s.compare(_T("https://list.iblocklist.com/lists/bluetack/edu")) == 0)
						{
							AddToDefLists(_T("https://list.iblocklist.com/lists/bluetack/edu"), _T("Default Edu List"), List::Block);
							EnableWindow(GetDlgItem(hwnd, IDC_OPENEDU), true);
...
static BOOL Lists_OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
	...
	{
		if (g_config.DynamicLists[i].Url.compare(_T("https://list.iblocklist.com/lists/bluetack/level-1")) == 0)
		{
		...
		else if (g_config.DynamicLists[i].Url.compare(_T("https://list.iblocklist.com/lists/bluetack/spyware")) == 0)
		{
		...
		else if (g_config.DynamicLists[i].Url.compare(_T("https://list.iblocklist.com/lists/bluetack/ads-trackers-and-bad-pr0n")) == 0)
		{
		...
		else if (g_config.DynamicLists[i].Url.compare(_T("https://list.iblocklist.com/lists/bluetack/edu")) == 0)
		{
