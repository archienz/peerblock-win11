...
public:
	...
	typedef range6 range6_type;
	typedef std::list<range6_type> list6_type;
	typedef list6_type::const_iterator const_iterator6;
...
public:
	...
	size_type size6() const {
		return this->_ranges6.size();
	}
	const_iterator6 begin6() const {
		return this->_ranges6.begin();
	}
	const_iterator6 end6() const {
		return this->_ranges6.end();
	}
	void clear() {
		this->_ranges.clear();
		this->_ranges6.clear();
